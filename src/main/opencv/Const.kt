...
//    internal var BOT_FRONT_SCALAR_MAX = Scalar(163.0, 255.0, 159.0)
    internal var BOT_FRONT_SCALAR_MIN = Scalar(145.0, 122.0, 183.0)
...
//    internal var BOT_BACK_SCALAR_MAX = Scalar(70.0, 255.0, 199.0)
    internal var BOT_BACK_SCALAR_MIN = Scalar(66.0, 100.0, 182.0)
    internal var BOT_BACK_SCALAR_MAX = Scalar(90.0, 165.0, 229.0)
    ...
    object FileName {
        const val REF_POINT = "config/reference_point_values.json"
    }
}
